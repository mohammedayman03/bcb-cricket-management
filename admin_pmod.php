...
if (isset($_GET['email'])) {
    ...
    if ($result) {
        ...
        if (isset($_POST['modify'])) {
            ...
            $checkEmailQuery = "SELECT * FROM admin WHERE email = '$modifiedEmail' AND email != '$email'";
            ...
            if (mysqli_num_rows($checkEmailResult) > 0) {
                ...
                if ($updateResult) {
                    echo '<script type="text/javascript">
                            ...
                            window.location.href = "admin_home.php?email=' . $modifiedEmail . '";
                          </script>';
                } else {
...
<body>
    ...
    <a href="admin_home.php?email=<?= $playerData['email'] ?>">Go Back to Home</a>
